...
if (isset($_GET['id_compra'])) {
 ...
 $sql = "SELECT * FROM festa where ID=".$_GET['id_compra'];
       ...
       <div class="left-side">
        <div class="itens">
          <div class="select-image">
             <img id="img1" src="assets/img/artigofesta/<?php echo $value['img'] ?>">
          </div>
          <div class="thumbnalls">
             <div class="thumbnall">
               <img id="img2" src="assets/img/artigofesta/<?php echo $value['img'] ?>" onclick="changeImage('assets/img/artigofesta/<?php echo $value['img'] ?>')">
            </div>

             <div class="thumbnall">
               <img id="img3" src="assets/img/artigofesta/<?php echo $value['img3'] ?>" onclick="changeImage('assets/img/artigofesta/<?php echo $value['img3'] ?>')">
            </div>
      ...
      <div class="right-side">
        <div class="content">
          ...
          <div class="options">
              ...
              <a href="add_to_cart4.php?id=<?php echo $value['ID']; ?>" class="button"><img src = "assets/img/testimonials/icon-cart.svg">Comprar</a>
          </div>
        </div>
      </div>    
...
$sql = "SELECT * FROM festa ORDER BY RAND() LIMIT 4";
...
<div class="center">
  ...
  ?>
    <div class="card">
      <a href="comprafesta.php?id_compra=<?php echo $value['ID'] ?>">
      <img src="assets/img/artigofesta/<?php echo $value['img']; ?>" alt="Produto" class="product-img">
      </a>
      <div class="container">
        ...
        <br>
        <a href="comprafesta.php?id_compra=<?php echo $value['ID'] ?>" type="button" class="btn btn-outline-danger">Comprar</a>
      </div>
    </div>
  <?php 
  } 
