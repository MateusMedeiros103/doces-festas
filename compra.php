...
$sql = "SELECT * FROM doces"; // Consulta padrão
if (isset($_GET['id_compra'])) {
    $id_compra = intval($_GET['id_compra']); // Garante que o ID seja um número inteiro
    $sql = "SELECT * FROM doces WHERE ID = $id_compra";
}
       ...
       <div class="left-side">
        <div class="itens">
          <div class="select-image">
             <img id="img1" src="assets/img/doces/<?php echo $value['img'] ?>">
          </div>
          <div class="thumbnalls">
             <div class="thumbnall">
               <img id="img2" src="assets/img/doces/<?php echo $value['img'] ?>" onclick="changeImage('assets/img/doces/<?php echo $value['img'] ?>')">
            </div>

             <div class="thumbnall">
               <img id="img3" src="assets/img/doces/<?php echo $value['img3'] ?>" onclick="changeImage('assets/img/doces/<?php echo $value['img3'] ?>')">
            </div>

            <div class="thumbnall">
               <img id="img4" src="assets/img/doces/<?php echo $value['img4'] ?>" onclick="changeImage('assets/img/doces/<?php echo $value['img4'] ?>')">
            </div>
      ...
      <div class="right-side">
        <div class="content">
          ...
          <div class="options">
              ...
              <a href="add_to_cart.php?id=<?php echo $value['ID']; ?>" class="button"><img src="assets/img/testimonials/icon-cart.svg">Comprar</a>
          </div>
        </div>
      </div>    
...
foreach ($dados as $value ) {
 ...
 <img src="assets/img/doces/<?php echo $value['img4'] ?>" style="width: 700px; height: 550px; margin-left: 50px;">
 </div>
...
$sql = "SELECT * FROM doces ORDER BY RAND() LIMIT 4";
...
<div class="center">
  ...
  ?>
    <div class="card">
      <a href="compra.php?id_compra=<?php echo $value['ID'] ?>">
      <img src="assets/img/doces/<?php echo $value['img']; ?>" alt="Produto" class="product-img">
      </a>
      <div class="container">
        ...
        <br>
        <a href="compra.php?id_compra=<?php echo $value['ID'] ?>" type="button" class="btn btn-outline-danger">Comprar</a>
      </div>
    </div>
  <?php 
  } 
