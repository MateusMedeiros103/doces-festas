        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Produtos</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="embalagens.php" class="active">Embalagens</a></li>
...
$conexao = mysqli_connect($servidor, $usuario, $senha, $banco);
 ...
 $sql = "SELECT * FROM embalagens WHERE 1";
...
$total_sql = "SELECT COUNT(*) as total FROM doces";
...
foreach ($dados as $value ) {
 ...
 ?>
          ...
          <a href="compraembalagem.php?id_compra=<?php echo $value['ID'] ?>">
            <img src="assets/img/embalgens/<?php echo $value['img'] ?>" alt="Product 1">
            </a>
            <div class="product-details">
              ...
              <center><a href="compraembalagem.php?id_compra=<?php echo $value['ID'] ?>">Comprar</a></center>
            </div>
          </div>
...
<?php 
 ...
 ?>
        ...
        <div class="sidebar">
          <div class="search">
          <form method="get" action="embalagens.php">
    ...
    <button type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
            ...
            <h3>Categorias</h3>
            <ul>
              <a href="embalagens.php?id_categoria=4#categories">- Bandeija</a><br>
              <a href="embalagens.php?id_categoria=5#categories">- Isopor</a><br>
              <a href="embalagens.php?id_categoria=7#categories">- Plástico</a><br>
              <a href="embalagens.php?id_categoria=6#categories">- Laminada</a><br>
